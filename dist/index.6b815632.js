...
class Chat {
    ...
    fetchMessages() {
        let html = ``;
        const mostViewedPosts = _database.query(_database.ref(_firebaseDefault.default, 'messages'));
        let messages = [];
        let dates = [];
        let notif = false;
        //Firebase Fetching Starts
        _database.onValue(mostViewedPosts, (snapshot)=>{
            ...
            for(const key in data1){
                messages.push({
                    message: data1[key]['message'],
                    name: data1[key]['name'],
                    createAt: data1[key]['createAt'],
                    date: new Date(data1[key]['createAt']).toLocaleDateString('en-US', {
                        month: '2-digit',
                        day: "2-digit",
                        year: "numeric"
                    })
                ...
                //     }
                // }
                dates.push(new Date(data1[key]['createAt']).toLocaleDateString('en-US', {
                    month: '2-digit',
                    day: "2-digit",
                    year: "numeric"
                }));
     ...
     <svg id="tip" width="10" height="12" viewBox="0 0 10 12" fill="none"
         ...
         <path
            ...
            ${msg.name === this.auth.fetchUser() ? `<svg id="tip" width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    sendMessage() {
        ...
        _database.set(_database.ref(_firebaseDefault.default, "messages/" + timestamp), {
            createAt: _database.serverTimestamp(),
...
},{"./classes/input":"fwKjL","./classes/firebase":"dpM00","firebase/database":"bpqHw","./classes/auth":"ffz0h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fwKjL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Input {
    ...
    sendSVG() {
        let path = document.querySelector("#sendpath");
        if (this.input.value !== '') path.style.fill = "#007AFF";
        else path.style.fill = "#8E8E93";
    }
}
...
},{}],"dpM00":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"ffz0h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Auth {
    constructor(){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eFQHZ","kuM8f"], "kuM8f", "parcelRequire21b9")
