...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/classes/input.ts":[function(require,module,exports) {
"use strict";
...
var Input = /*#__PURE__*/function () {
  ...
  _createClass(Input, [{
    key: "initlalize",
    value: function initlalize() {
      var input = document.querySelector('input');
      return input;
    }
  }, {
    key: "sendAnimate",
    value: function sendAnimate() {
      var _this = this;
    ...
    key: "sendSVG",
    value: function sendSVG() {
      var path = document.querySelector("#sendpath");
...
},{"@firebase/app":"node_modules/@firebase/app/dist/esm/index.esm2017.js"}],"C:/Users/Jawad/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"@firebase/database":"node_modules/@firebase/database/dist/index.esm2017.js"}],"src/classes/firebase.ts":[function(require,module,exports) {
...
},{"firebase/app":"node_modules/firebase/app/dist/index.esm.js","firebase/database":"node_modules/firebase/database/dist/index.esm.js"}],"src/classes/auth.ts":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Auth, [{
    ...
    value: function fetchUser() {
      ...
      if (Object.keys(this.user).length === 0) {
        this.user = (_a = localStorage.getItem('user')) !== null && _a !== void 0 ? _a : {};
...
var input_1 = __importDefault(require("./classes/input"));

var firebase_1 = __importDefault(require("./classes/firebase"));

var database_1 = require("firebase/database");

var auth_1 = __importDefault(require("./classes/auth"));
...
var Chat = /*#__PURE__*/function () {
  function Chat() {
    ...
    if (this.auth.fetchUser() === null) {
      ...
      var name = prompt("What is Your Name?", "guest-" + r);
      if (name !== '' && name !== null) localStorage.setItem("user", name);
    } else {
      var mostViewedPosts = (0, database_1.query)((0, database_1.ref)(firebase_1.default, 'messages'));
      var messages = [];
      var dates = [];
      (0, database_1.onValue)(mostViewedPosts, function (snapshot) {
  ...
  _createClass(Chat, [{
    key: "resizeChatWindow",
    value: function resizeChatWindow() {
      ...
      var chatHeight = window.innerHeight - (headerHeight + footerHeight);
    ...
    value: function sendMessage() {
      ...
      send.addEventListener('click', function () {
        var r = (Math.random() + 1).toString(36).substring(7);
        var message = _this2.input.inputValue;
        if (message === '') return;
        var timestamp = Date.now();
        (0, database_1.set)((0, database_1.ref)(firebase_1.default, "messages/" + timestamp), {
          createAt: (0, database_1.serverTimestamp)(),
          name: _this2.auth.fetchUser(),
          message: message
        });

        _this2.input.sendSVG();
      });
    }
  }]);
...
var chat = new Chat();
},{"./classes/input":"src/classes/input.ts","./classes/firebase":"src/classes/firebase.ts","firebase/database":"node_modules/firebase/database/dist/index.esm.js","./classes/auth":"src/classes/auth.ts"}],"C:/Users/Jawad/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/Jawad/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.ts"], null)
